$(document).ready(function(){
    ...
    // Resolution responsive variables
...
function greetUser()
{
    ...
    if( hr >= 0 && hr < 12)
    {
        greetmsg.innerHTML = "Good Morning User!<br>How can I help you today?";
    }
    else if( hr >= 12 && hr < 17)
    {
